...
#include "stdafx.h"
#include "spitoniceventssynthvoroguiwin32.h"
#include "FreeImage.h"
...
TCHAR szTitle[1024]={L"spitoniceventssynthvoroguiwin32title"};					// The title bar text
TCHAR szWindowClass[1024]={L"spitoniceventssynthvoroguiwin32class"};				// the main window class name
